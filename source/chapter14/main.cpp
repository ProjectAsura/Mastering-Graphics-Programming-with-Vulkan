    ...
    while ( !window.requested_exit ) {
...

        {
            ...
            if ( gpu_lighting_data ) {
                ...
                raytraced_light_color_type_packed.set( raytraced_shadow_light_color.x, raytraced_shadow_light_color.y, raytraced_shadow_light_color.z, f32(raytraced_shadow_light_type) );
